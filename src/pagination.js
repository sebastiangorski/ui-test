...
let WcPagination = class WcPagination extends s {
    ...
    renderPageButtons() {
        const pages = this.withElipsis ? this.calculateVisiblePagesWithElipsis() : this.calculateVisiblePagesWithoutElipsi();
        return pages.map((page) => {
            const disabled = page === '...' || this.currentPage === page;
            const currentPage = page === this.currentPage ? 'current' : '';
            const elipsis = page === '...' ? 'elipsis' : '';
            return x `
        <button
    ...
    calculateVisiblePagesWithoutElipsi() {
        const pageRange = [];
