...
class WcPagination extends s {
    ...
    render() {
        return x `
      <div>
        ${n(!this.textControls, () => this.renderControlButton('first'))} ${this.renderControlButton('previous')}
        ${this.renderPageButtons()} ${this.renderControlButton('next')}
        ${n(!this.textControls, () => this.renderControlButton('last'))}
      </div>
    `;
    }
    renderControlButton(buttonType) {
        ...
        return x `
      <button
        class="pagination-button ${e(classes)}"
    ...
    renderPageButtons() {
        ...
        return pages.map((page) => {
            ...
            const disabled = page === '...' || this.currentPage === page;
            return x `
        <button
          class="pagination-button ${e(classes)}"
          button-style="${this.buttonStyle}"
    ...
    calculateVisiblePagesWithElipsis() {
...
__decorate([
    n$1({ type: Number })
], WcPagination.prototype, "currentPage", void 0);
__decorate([
    n$1({ type: Number })
], WcPagination.prototype, "totalPages", void 0);
__decorate([
    n$1({ type: Number })
], WcPagination.prototype, "pagesToShow", void 0);
__decorate([
    n$1({ type: ButtonStyle })
], WcPagination.prototype, "buttonStyle", void 0);
__decorate([
    n$1({ type: Boolean })
], WcPagination.prototype, "textControls", void 0);
__decorate([
    n$1({ type: Boolean })
...
export { ButtonStyle, WcPagination };
