...
class WcPagination extends s {
    ...
    renderPageButtons() {
        const pages = this.withElipsis
            ...
            : this.calculateVisiblePagesWithoutElipsi();
